 ...
 * rule before this option existed.
 *
 ...
 * vector rather than an image request. `isSafeResolvedImageSrc` below is a
 * narrow denylist for exactly that, not a repeat of the author-facing
 * allowlist.
 */
