// smd-lua: the sandboxed Lua 5.4 (wasmoon) execution primitive backing
// spec §8 (scripting), §10 (capability security), and §11 (bundle-scoped
// filesystem). No React, no smd-core, no smd-react — see CLAUDE.md's
// import rule and the ESLint guard in the root config. May depend on
// smd-bundle for the `ScriptView` capability type only.
