...
Mark is markdown that renders your own components. A `.mk.md` file is plain
...
and sandboxed scripts feeding them live data, in anything that speaks Mark.
...
line Mark holds: components and scripts feed the document; they never become
...
To render Mark documents in your own React app:
